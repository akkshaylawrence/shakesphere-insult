...
const mildWords = new Set([
    ...
    function speak(text) {
        if (!('speechSynthesis' in window)) {
            showStatus('Speech is not supported in this browser.');
            return;
        }
        ...
        utterance.voice = voices.find(voice => voice.lang.includes('en-GB')) || voices.find(voice => voice.lang.includes('en')) || null;
    ...
    function renderFavorites() {
        ...
        favorites.forEach((text, index) => {
            ...
            actions.append(speakButton, copyButton, removeButton);
    ...
    document.getElementById('speak-btn').addEventListener('click', () => speak(buildInsult()));
